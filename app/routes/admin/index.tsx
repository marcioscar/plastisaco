    ...
    <>
      <nav className="bg-slate-200">
        <div className="max-w-7xl mx-auto p-2 sm:px-6 lg:px-8 flex items-center justify-between">
          <img className="w-40 lg:w-96" src="plastisaco_logo.svg" alt="logo" />
                ...
                >
                  ...
                  <td>
                    <div className="text-center items-center  whitespace-nowrap">
                      <Link
                        to={user.id}
                        className=" text-white bg-slate-400/75 hover:bg-[#1da1f2]/80 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-2 py-2 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 m-2"
                      >
                        <svg
